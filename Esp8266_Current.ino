...
const char* ssid     = "Mi 10T"; // ESP32 and ESP8266 uses 2.4GHZ wifi only
const char* password = "rahayu123"; 
const char* mqttuser     = "annas_dzik"; // ESP32 and ESP8266 uses 2.4GHZ wifi only
...
#define mqttarduino "arduino_fyp" //topic for ultrasonic
  ...
  if (err == DeserializationError::Ok)     //if json object is received , run this function
    {
      ...
      Serial.println(doc["Voltage"].as<int>()); //json object name for water level
      Serial.print("Current = ");
      Serial.println(doc["Current"].as<float>()); //json object name for tds 
      Serial.print("Power = ");
      Serial.println(doc["Power"].as<float>()); //json object name for ph
      Serial.print("Energy = ");
      Serial.println(doc["Energy"].as<float>()); //json object name for ph
      Serial.print("Frequency = ");
      Serial.println(doc["Frequency"].as<float>()); //json object name for ph
      Serial.print("Power Factor = ");
      Serial.println(doc["Power Factor"].as<float>()); //json object name for temperature
      Serial.println("\n");
